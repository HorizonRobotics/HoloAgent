...
It provides the needed methods to manipulate the coordinates and calculate the
cost of a Footprint
"""
...
class FootprintCollisionChecker:
    ...
    FootprintCollisionChecker Class for getting the cost and checking the
    collisions of a Footprint
    """
